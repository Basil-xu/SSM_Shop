...
<head>
  ...
  <link rel="stylesheet" href="/Shop_After/assets/css/Login/amazeui.min.css">
  <link rel="stylesheet" href="/Shop_After/assets/css/Login/app.css">
<script type="text/javascript" src="/Shop_After/assets/js/Login/jquery.js"></script></head>
<body>
...
<!--[if (gte IE 9)|!(IE)]><!-->
<script src="/Shop_After/assets/js/Login/jquery.min.js"></script>
<!--<![endif]-->
<!--[if lte IE 8 ]>
...
<![endif]-->
<script src="/Shop_After/assets/js/Login/amazeui.min.js"></script>
<script src="/Shop_After/assets/js/Login/app.js"></script>
</body>
